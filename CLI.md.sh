...
generate() {
    ...
    command "Contract.Unverify" "contract unverify"
    ...
    command "Token.UnsetBurnRoleGlobally" "token unset-burn-role-globally"
    command "Token.SetSpecialRoleFungible" "token set-special-role-fungible"
    command "Token.UnsetSpecialRoleFungible" "token unset-special-role-fungible"
    command "Token.SetSpecialRoleSemiFungible" "token set-special-role-semi-fungible"
    command "Token.UnsetSpecialRoleSemiFungible" "token unset-special-role-semi-fungible"
    command "Token.SetSpecialRoleMetaEsdt" "token set-special-role-meta-esdt"
    command "Token.UnsetSpecialRoleMetaEsdt" "token unset-special-role-meta-esdt"
    command "Token.SetSpecialRoleNft" "token set-special-role-nft"
    command "Token.UnsetSpecialRoleNft" "token unset-special-role-nft"
    command "Token.CreateNft" "token create-nft"
    command "Token.Pause" "token pause"
    command "Token.Unpause" "token unpause"
    command "Token.Freeze" "token freeze"
    command "Token.Unfreeze" "token unfreeze"
    command "Token.Wipe" "token wipe"
    command "Token.LocalMint" "token local-mint"
    command "Token.LocalBurn" "token local-burn"
    command "Token.UpdateAttributes" "token update-attributes"
    command "Token.AddQuantity" "token add-quantity"
    command "Token.BurnQuantity" "token burn-quantity"
    command "Token.ModifyRolaties" "token modify-royalties"
    command "Token.SetNewUris" "token set-new-uris"
    command "Token.ModifyCreator" "token modify-creator"
    command "Token.UpdateMetadata" "token update-metadata"
    command "Token.NftMetadataRecreate" "token nft-metadata-recreate"
    command "Token.ChangeToDynamic" "token change-to-dynamic"
    command "Token.UpdateTokenId" "token update-token-id"
    command "Token.RegisterDynamic" "token register-dynamic"
    command "Token.RegisterDynamicAndSetAllRoles" "token register-dynamic-and-set-all-roles"
    command "Token.TransferOwnership" "token transfer-ownership"
    command "Token.FreezeSingleNft" "token freeze-single-nft"
    command "Token.UnfreezeSingleNft" "token unfreeze-single-nft"
    command "Token.ChangeSftToMetaEsdt" "token change-sft-to-meta-esdt"
    command "Token.TransferNftCreateRole" "token transfer-nft-create-role"
