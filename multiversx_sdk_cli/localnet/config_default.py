...
software = Software(
    ...
    mx_chain_proxy_go=SoftwareChainProxyGo(
        ...
        archive_download_folder=Path("~/multiversx-sdk") / "localnet_software_remote" / "downloaded" / "mx-chain-proxy-go",
        archive_extraction_folder=Path("~/multiversx-sdk") / "localnet_software_remote" / "extracted" / "mx-chain-proxy-go",
